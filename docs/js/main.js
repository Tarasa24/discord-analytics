...
var scrapeList = [
  'discord-scrape_r_DiscordApp.json',
  "discord-scrape_Chewwy's-Departure-Lounge.json",
];
...
function user_tables_construct() {
  ...
  table_name.innerHTML =
    ...
    'Not avalible in static version' +
    '</i></td></tr> <tr><th>First message</th><td><i>' +
    User['firstMessage'] +
    '</i></td></tr> <tr><th>Last message</th><td><i>' +
    User['lastMessage'] +
